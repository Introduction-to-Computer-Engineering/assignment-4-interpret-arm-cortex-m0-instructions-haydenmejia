...
| | [ldr](http://infocenter.arm.com/help/topic/com.arm.doc.dui0497a/BABJGHFJ.html)     `r3, [sp, #4]` |load register from PC-related adress r0 to the memory with adress sp + 4  |
